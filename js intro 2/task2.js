...
function Validate(keyword, count, callback, name) {
  if ((keyword === "")| typeof(keyword) !=='string' | isNaN(count) | count<=0){ //validate
...
Validate('an', 3, search, name); //jalankan function Validate()
